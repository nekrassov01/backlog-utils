...
LDFLAGS := "-s -w -X github.com/nekrassov01/backlog-utils/version.version=$(VERSION) -X github.com/nekrassov01/backlog-utils/version.revision=$(REVISION)"
...
version: deps-bump
	@echo $(shell gobump show -r ./version/)
